<div class="sidebar" data-color="black" data-image="<?php echo e(asset('static/img/sidebar-5.jpg')); ?>">
    ...
    <div class="sidebar-wrapper">
        ...
        <div class="user">
            <div class="photo">
                <img src="<?php echo e(asset('static/img/default-avatar.png')); ?>" />
            </div>
            <div class="info">
                <a data-toggle="collapse" href="#collapseExample" class="collapsed">
                    <span><?php echo e(Auth::User()->nombres); ?>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/correspondencia/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>